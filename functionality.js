...
const nodeOne = document.createTextNode("Can not be zero");
const nodeTwo = document.createTextNode("Can not be zero");
...
function myFunc() {
  ...
  function totalValue () {
    if (input.value !== 0 &&	people.value !== 0) {
      return "$" + ((input.value / people.value) + ((input.value * customInput.value) / 100) / people.value);
    } else {
      return "Incorret";
    }
    };
...
function myFunctionOne() {
  ...
  function totalValue () {
    if (input.value !== 0 &&	people.value !== 0) {
      return "$" + ((input.value / people.value) + ((input.value * 5) / 100) / people.value);
    } else {
      return "Incorret";
    }
    };
...
function myFunctionTwo() {
  ...
  function totalValue () {
    if (input.value !== 0 &&	people.value !== 0) {
      return "$" + ((input.value / people.value) + ((input.value * 10) / 100) / people.value);
    } else {
      return "Incorret";
    }
    };
...
function myFunctionThree() {
  ...
  function totalValue () {
    if (input.value !== 0 &&	people.value !== 0) {
      return "$" + ((input.value / people.value) + ((input.value * 15) / 100) / people.value);
    } else {
      return "Incorret";
    }
    };
...
function myFunctionFour() {
  ...
  function totalValue () {
    if (input.value !== 0 &&	people.value !== 0) {
      return "$" + ((input.value / people.value) + ((input.value * 25) / 100) / people.value);
    } else {
      return "Incorret";
    }
    };
...
function myFunctionFive() {
  ...
  function totalValue () {
    if (input.value !== 0 &&	people.value !== 0) {
      return "$" + ((input.value / people.value) + ((input.value * 50) / 100) / people.value);
    } else {
      return "Incorret";
    }
    };
